<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- Add your CRM links here --}}
                    <x-nav-link :href="route('contacts.index')" :active="request()->routeIs('contacts.*')">
                        {{ __('Contacts') }}
                    </x-nav-link>
                    <x-nav-link :href="route('custom-fields.index')" :active="request()->routeIs('custom-fields.*')">
                        {{ __('Custom Fields') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- CRM Links for Mobile --}}
            <x-responsive-nav-link :href="route('contacts.index')" :active="request()->routeIs('contacts.*')">
                {{ __('Contacts') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('custom-fields.index')" :active="request()->routeIs('custom-fields.*')">
                {{ __('Custom Fields') }}
            </x-responsive-nav-link>
        </div>
